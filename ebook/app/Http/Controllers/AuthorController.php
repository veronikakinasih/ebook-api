...
class AuthorController extends Controller
{
    ...
    public function show($id)
    {
        ...
        if ($author) {
            ...
            return response()->json([
                'status' => 404,
                'message' => 'id atas' . $id . 'Ga ada bro, teliti lagi coba!'
            ], 404);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($author){
            ...
            return response()->json([
                'status'=>404,
                'message'=> $id . 'Ga ada bro, teliti lagi coba!'
            ], 404);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if($author){
            ...
            return response()->json([
                'status' => 404,
                'message' => 'id' . $id . 'Ga ada bro, teliti lagi coba!'            
            ], 404);
        }
    }
}